...
export const LicenseCards = [
    {questionText : 'Commercial Location Business',
    ...
    addinfo : 'License for businesses based at commercially zoned properties',
    endpage : true,
    requirements : [],
    },
    {questionText : 'Home-Based Business', 
    categoryText : 'License',
    id : 1, 
    nextPage : 2,
    endpagelink : 'https://selfservice.claytoncountyga.gov/EnerGovProd/SelfService#/businessLicense/apply/business/153',
    addinfo : 'License for businesses based at residentially zoned properties',
    endpage : true,
    requirements : [],
    },
